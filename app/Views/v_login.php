...
<body class="bg-white">
    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="login-form mt-1">
            <div class="section">
                <img src="<?=base_url('front')?>/assets/img/sample/photo/vector4.png" alt="image" class="form-image">
            </div>
                ...
                <?php echo form_open('Auth/cekLoginKaryawan') ?>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <input name="username" class="form-control" id="email1" placeholder="Username">
